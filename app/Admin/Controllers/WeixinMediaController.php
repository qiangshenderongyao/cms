...
class WeixinMediaController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->format('Format');
        $grid->msg_id('Msg id');
        $grid->local_file_name('Local file name')->display(function($wx_imgage_put){
            return '<img src="http://1807.96myshop.cn/images/'.$wx_imgage_put.'" style="width:30px;hight:30px;">';
        });
